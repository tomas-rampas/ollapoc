...
public sealed class IntentRouter
{
    ...
    [
        ...
        (new Regex(@"\b(give me (?:all|some|any|the|\d+)|list all|show me|find all|records?|count of|how many|how much|number of|fetch|get all|top \d+|count|aggregate|filter by|search for|query the)\b",
